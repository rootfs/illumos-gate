...
/**
 * \brief Currently available byteswap functions.
 *
...
/**
 * \brief Attribute to register support for.
 */
...
/**
 * \brief array of attributes to store.
 *
...
/**
 * \brief special macro for adding entries for bulk attr support
 * 	- bulk - sa_bulk_attr_t
