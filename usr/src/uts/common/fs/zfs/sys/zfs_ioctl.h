...
/**
 * \brief Header types for zfs send streams.
 */
...
/**
 * \brief Mask of all supported backup features
 */
#define	DMU_BACKUP_FEATURE_MASK	(DMU_BACKUP_FEATURE_DEDUP | \
		DMU_BACKUP_FEATURE_DEDUPPROPS | DMU_BACKUP_FEATURE_SA_SPILL)

/** \brief Are all features in the given flag word currently supported? */
...
/**
 * \brief zfs ioctl command structure
 */
struct drr_begin {
	uint64_t drr_magic;
	/**
...
/**
 * \brief The diff reports back ranges of free or in-use objects.
 */
