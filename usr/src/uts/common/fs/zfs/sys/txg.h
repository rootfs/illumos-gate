...
/**
 * Wait until the given transaction group starts syncing.
 *
 ...
 *
 * \retval TRUE   We are "backed up" waiting for the syncing
...
/**
 * \return  TRUE if someone is waiting for the next txg to sync
 */
