...
/**
 * \brief Intent log transaction lists
 */
typedef struct itxs {
...
/**
 * \brief for async nodes we build up an AVL tree of lists of async itxs per
 * file
 */
...
/**
 * \brief Stable storage intent log management structure.
 *
 * One per dataset.
 */
struct zilog {
