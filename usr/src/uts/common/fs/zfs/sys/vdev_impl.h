...
/**
 * \file vdev_impl.h
 * \brief Virtual device descriptors.
 *
...
/**
 * \brief A virtual device property
 */
...
/**
 * \brief Virtual device descriptor
 */
struct vdev {
	/**
	 * \name VDev common 
	...
	/**
	 * \brief block alignment shift
	 *
	 * Forces all IO to this VDev to be aligned to multiples of (1 <<
	 * vdev_ashift) bytes.
	 */
