...
/**
 * \brief Size of block to hold the configuration data (a packed nvlist)
 */
...
/**
 * The byteorder is either 0 or -1, both of which are palindromes.
...
/**
 * \brief Defer frees after this pass
 *
