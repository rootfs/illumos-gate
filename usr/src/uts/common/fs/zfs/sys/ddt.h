...
extern void ddt_object_name(ddt_t *ddt, enum ddt_type type,
    enum ddt_class ddt_class, char *name);
extern int ddt_object_walk(ddt_t *ddt, enum ddt_type type,
    enum ddt_class ddt_class, uint64_t *walk, ddt_entry_t *dde);
extern uint64_t ddt_object_count(ddt_t *ddt, enum ddt_type type,
    enum ddt_class ddt_class);
extern int ddt_object_info(ddt_t *ddt, enum ddt_type type,
    enum ddt_class ddt_class, dmu_object_info_t *);
...
extern int ddt_object_update(ddt_t *ddt, enum ddt_type type,
    enum ddt_class ddt_class, ddt_entry_t *dde, dmu_tx_t *tx);
