...
/**
 * \brief Array of known attributes and their various characteristics.
 */
...
/**
 * \brief header for all bonus and spill buffers.
 *
...
typedef struct sa_hdr_phys {
	uint32_t sa_magic;
	/**
	 * Encoded with hdrsize and layout number 
...
/**
 * \brief Opaque handle used for most sa functions
 *
