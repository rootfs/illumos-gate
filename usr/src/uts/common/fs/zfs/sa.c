...
/**
 * \brief List of legacy attributes
 *
 * This table is fixed and cannot be changed.  Its purpose is to allow the SA
 * code to work with both old/new ZPL file systems.  These attributes aren't
 * stored in the "attribute" registry zap objects, since older ZPL file systems
 * won't have the registry.  Only objsets of type ZFS_TYPE_FILESYSTEM will use
 * this static table.
 */
...
/**
 * \brief Special dummy layout used for buffers with no attributes.
 */
...
/**
 * \brief Main attribute lookup/update function
 *
...
/**
 * \brief Find layout that corresponds to ordering of attributes
 *
...
/**
 * \brief Replace all attributes with attributes specified in template.
 *
...
/**
 * \brief update or add new attribute
 */
int
...
/**
 * \brief Return size of an attribute
 */
int
